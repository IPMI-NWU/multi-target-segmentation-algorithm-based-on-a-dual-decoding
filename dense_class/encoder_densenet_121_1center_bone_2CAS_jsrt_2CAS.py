...
class DenseNet_resDecoder(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16), num_init_features=64,
        ...
        # 解码器1-跳跃连接
        self.skip0_att_d1 = CAS(channels[0], channels[0], channels[0] // 2)
        self.skip1_att_d1 = CAS(channels[1], channels[1], channels[1] // 2)
...
def densenet121_resDecoder(pretrained=True, num_classes_d1=3, num_classes_d2=4, **kwargs):
    """DenseNet121"""
    print('using densenet121_resDecoder 1center-denseblock bone 2CAS jsrt 2CAS 2layer')
