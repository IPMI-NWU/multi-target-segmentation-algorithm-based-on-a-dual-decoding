...
class _AsppBlock(nn.Sequential):
    ...
    def __init__(self, input_num, output_num, dilation_rate, weight_std=False, drop_out=0.2):
...
class ASPPBlock(nn.Module):
    def __init__(self, num_features, weight_std=False, output_num=512, dropout0=0.2):
