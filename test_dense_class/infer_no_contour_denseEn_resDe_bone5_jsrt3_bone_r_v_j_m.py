...
def save_img(output, img_name, fold, dir_name, task_type):
    path = r'../../result_bone5_JSRT3_bone_r_j_v_m/' + dir_name + ''
...
def infer(testloader, outTxtPath, fold, model_index, dir_name, type='bone'):
    ...
    model_pth = [
        ...
        [
            # 第一折
            [
                'r_j_v_m/bone/fold_0/model_bone_149-0.910986.pth',
            ],
            # 第二折
            [
                'r_j_v_m/bone/fold_1/model_bone_145-0.902830.pth',
            ],
            # 第三折
            [
                'r_j_v_m/bone/fold_2/model_bone_133-0.904121.pth',
            ],
            # 第四折
            [
                'r_j_v_m/bone/fold_3/model_bone_149-0.901259.pth',
            ],
        ],
    ]
