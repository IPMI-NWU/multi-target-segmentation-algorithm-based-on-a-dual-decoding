...
def save_img(output, img_name, fold, dir_name, task_type):
    path = r'../../result_bone5_JSRT3_bone/' + dir_name + ''

    mkdir(path)

    path = os.path.join(path, 'bone_fold_' + str(fold), task_type)
    mkdir(path)
...
def infer(testloader, outTxtPath, fold, model_index, dir_name, type='bone'):
    ...
    model_pth = [
        ...
        [
            [
                'bone5_others3_class/2023_2_17_clavicle1.5_bone5_jsrt3_split_denseEn_resDe_two_decoder_1center_denseblock_4fold_bone_2CAS_jsrt_2AG_bone_AMFS_jsrt_AMFS137_deep_supervision_map2_map3_bone_0.6_0.4_1/fold_0/bone/bone/model_bone_149-0.910986.pth',
            ],

            [
                'bone5_others3_class/2023_2_17_clavicle1.5_bone5_jsrt3_split_denseEn_resDe_two_decoder_1center_denseblock_4fold_bone_2CAS_jsrt_2AG_bone_AMFS_jsrt_AMFS137_deep_supervision_map2_map3_bone_0.6_0.4_1/fold_1/bone/bone/model_bone_145-0.902830.pth',
            ],

            [
                'bone5_others3_class/2023_2_17_clavicle1.5_bone5_jsrt3_split_denseEn_resDe_two_decoder_1center_denseblock_4fold_bone_2CAS_jsrt_2AG_bone_AMFS_jsrt_AMFS137_deep_supervision_map2_map3_bone_0.6_0.4_1/fold_2/bone/bone/model_bone_133-0.904121.pth',
            ],

            [
                'bone5_others3_class/2023_2_17_clavicle1.5_bone5_jsrt3_split_denseEn_resDe_two_decoder_1center_denseblock_4fold_bone_2CAS_jsrt_2AG_bone_AMFS_jsrt_AMFS137_deep_supervision_map2_map3_bone_0.6_0.4_1/fold_3/bone/bone/model_bone_149-0.901259.pth',
            ],
        ],
    ]
    ...
    model_path = os.path.join(r'../../compare_experiment/OUT/no_contour', model_pth[model_index][fold][task_type])
...
if __name__ == '__main__':
    ...
    for i in range(0, num):
        ...
        if type_task == 'bone':
            test_img_label_txt = r'../../dataset/bone_fake_data/txt_lihangsheng_fake_data_20/fold' + str(i) + '/test.txt'
