...
def main2():
    ...
    file_name = '2023_2_12_aug_bone4_jsrt3_denseEn_resDe_two_decoder_1center_denseblock_4fold_bone_2CAS_jsrt_2AG_bone_AMFS_jsrt_AMFS137_deep_supervision_map2_map3_weight_std_bone10'
    return file_name, model
...
if __name__ == "__main__":
    ...
    for model_index in model_num:
        # the num of fold
        for i in range(2, zhe):  # 每一折应该是一个新的model,之前是个傻逼吧,竟然用同一个model在跑
            if model_index == 1:
